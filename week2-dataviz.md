...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/chord_diagram.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/chord_diagram.svg)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/histogram.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/histogram.png)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/PNG/connection_map.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/connection_map.svg)

DistributionLocationMovementPatternsRelationships
...
![top image](http://datavizcatalogue.com/methods/images/top_images/donut_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/donut_chart.png)

ComparisonsPart-to-a-wholeProportions
...
![top image](http://datavizcatalogue.com/methods/images/top_images/dotmatrix.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/dotmatrix.png)

ComparisonsDistributionPatternsProportions

Pictogram Chart

<!--
Dot Matrix Charts display discreet data through a series of organised dots, each coloured to represent a particular category and grouped in a matrix. They are used to give a quick overview of the distribution and proportions of each category in a data set. Dot Matrix Charts are also used to compare distribution and proportion across other datasets, to discover patterns.

When only one category is used in the dataset and all the dots are the same colour, a Dot Matrix Chart can be used to primarily show proportions.
 -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/flow_map.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/flow_map.png)

DistributionLocationMovement & Flow
...
![top image](http://datavizcatalogue.com/methods/images/top_images/sankey_diagram.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/sankey_diagram.png)

How things workFlowProcessProportions
...
The thickness of the arrows and lines shows their magnitudes or quantities. Flow arrows or lines can combine or split apart at each stage of a process.
...
Often, Sankey Diagrams are confused with Parallel Sets and Alluvial Diagrams, but this post clarifies the differences.
 -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/calendar.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/calendar.png)

Data over timeReference Tool
...
Today, the most common form of Calendar is the Gregorian Calendar. Typically it's displayed in separate monthly grids of seven columns (for each day of the week) and five to six rows. However, the format for any calendar is not set in stone so their design can vary, so long as they visually show the chronological sequence of dates or time units.

A list of different ways Calendars can be combined with other forms of data visualisation can be found here.
-->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/flow_chart.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/flow_chart.svg)

ConceptsHow things workProcesses & methods
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/stem_and_leaf_plot.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/stem_and_leaf_plot.svg)

DistributionReference Tool
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/kagi_chart.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/kagi_chart.svg)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/circle_packing.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/circle_packing.svg)

HierarchyProportions
...
![top image](http://datavizcatalogue.com/methods/images/top_images/bubble_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/bubble_chart.png)

ComparisonsData over timeDistributionPatternsProportionsRelationships
...
![top image](http://datavizcatalogue.com/methods/images/top_images/radar_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/radar_chart.png)

ComparisonsPatternsRelationships
...
However, there are some major flaws with using Radar Charts:
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/candlestick_chart.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/candlestick_chart.svg)

Data over timePatternsRanges
...
![top image](http://datavizcatalogue.com/methods/images/top_images/multiset_barchart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/multiset_barchart.png)

ComparisonsDistributionPatternsRelationships
...
![top image](http://datavizcatalogue.com/methods/images/top_images/pie_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/pie_chart.png)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/treemap.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/treemap.png)

ComparisonsHierarchyPart-to-a-wholeProportions
...
The downside to Treemaps is that they doesn't show the hierarchal levels as clearly as other charts that visualise hierarchal data (such as a Tree Diagram or Sunburst Diagram).
-->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/illustration_diagram.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/illustration_diagram.png)
...
Explain concepts or methodsDescribe objects or placesShow how things work, move or changeHelp provide additional insight into the subject displayed
...
![top image](http://datavizcatalogue.com/methods/images/top_images/span_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/span_chart.png)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/bullet_graph.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/bullet_graph.svg)
...
<!--
Used typically to display performance data, a Bullet Graph functions like a Bar Chart, but is accompanied by extra visual elements to pack in more context. Originally, Bullet Graphs were developed by Stephen Few as an alternative to dashboard gauges and meters, because they often displayed not enough information, were less space-efficient and were cluttered with "chartjunk".

In a Bullet Graph, the main data value is encoded by length with the bar in the centre of the chart, which is known as the Feature Measure. The line marker that runs perpendicular to the orientation of the graph is known as the Comparative Measure and is used as a target marker to compare against the Feature Measure value. So if the main bar has passed the position of Comparative Measure, you know you've hit your goal.

The segmented coloured bars behind the Feature Measure are used to display qualitative range scores. Each colour shade (the three shades of grey in the example above) are used to assign a performance range rating. So for example, poor, average and great. When using Bullet Graphs, it's ideal to keep the maximum number of performance ranges to five.

- - -

You can find out more on Bullet Graphs in Stephen Few's guide: Bullet Graph Design Specification
-->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/radial_column_chart.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/radial_column_chart.svg)
...
This type of graph plots bars on a polar coordinate system. Concentric circles are used for the value scale, while the radial dividers (lines spanning from the centre) are used to plot each category.

Typically, the lower values on the scale start from the centre and increase with each circle outwards. The bars are plotted extending outwards from the centre based on this concentric circle value scale.

Negative values can also be displayed on a Radial Column Chart, by having zero starting from any of the outer circles (from the central one) and all circles within it used for negative values.
 -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/population_pyramid.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/population_pyramid.png)

ComparisonsDistributionPatterns
...
A Population Pyramid is a pair of back-to-back Histograms (for each sex) that displays the distribution of a population in all age groups and both sexes. The x-axis is used to plot population numbers and the y-axis lists all age groups.
...
Population Pyramids can also be used to speculate a population’s future development. An ageing population that is not reproducing would eventually run into issues such as having enough offspring to care for the elderly. Other theories such as the “Youth Bulge” state that when there’s a wide bulge around the 16-30 age range, particularly in males, this leads to social unrest, war and terrorism.

This makes Population Pyramids useful for fields such as Ecology, Sociology and Economics.
 -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/timetable.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/timetable.png)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/marimekko_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/marimekko_chart.png)

ComparisonsPart-to-a-wholeProportionsRelationships
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/stream_graph.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/stream_graph.svg)

Data over timePatterns
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/nightingale_rose_chart.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/nightingale_rose_chart.svg)

ComparisonsData over timeProportions
...
![top image](http://datavizcatalogue.com/methods/images/top_images/tree_diagram.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/tree_diagram.png)

HierarchyReference ToolRelationships
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/parallel_coordinates.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/parallel_coordinates.svg)

ComparisonsRelationshipsPatterns
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/venn_diagram.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/venn_diagram.svg)

ComparisonsConceptsRelationships
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/OHLC_chart.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/OHLC_chart.svg)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/non_ribbon_chord_diagram.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/non_ribbon_chord_diagram.svg)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/density_plot.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/density_plot.svg)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/PNG/sunburst_diagram.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/sunburst_diagram.svg)

HierarchyPart-to-a-whole
...
![top image](http://datavizcatalogue.com/methods/images/top_images/parallel_sets.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/parallel_sets.png)

ComparisonsDistributionFlowProcesses & MethodsProportions

Sankey Diagram

<!--
Parallel Sets are similar to  Sankey Diagrams in the way they show flow and proportions. However, Parallel Sets don’t use arrows and they divide the flow-path at each displayed line set.
...
The development process of Parallel Sets can be found in Robert Kosara's papers:
...
![top image](http://datavizcatalogue.com/methods/images/top_images/arc_diagram.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/arc_diagram.png)
...
Combining Arc Diagrams with other visualisations.
...
![top image](http://datavizcatalogue.com/methods/images/top_images/PNG/spiral_plot.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/PNG/spiral_plot.png)
...
- - -Papers on the development of Spiral Plots:
...
![top image](http://datavizcatalogue.com/methods/images/top_images/timeline.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/timeline.png)

Data over timeDistributionPatterns
...
If scale-based, a Timeline allows you to see when things occur or are to occur, by allowing the viewer to assess the time intervals between events. This allows the viewer to see any patterns appearing over any selected time period or how events are distributed in that time period.

Other forms of data visualisation can be combined with a Timeline to show how quantitative data changes over time. For example, the bars of a Span Chart could be used to show the duration of events. Here is a blog post showcasing a list of Timeline combinations.
When scaled: -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/tally_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/tally_chart.png)

ComparisonsDistribution

<!--
A Tally Chart is both a tool for recording and graphically showing the frequency of the distribution of data by using the tally mark numeral system.

When constructing tally charts, categories, values or intervals are placed in one axis or column (typically the Y-axis or first column on the left). Each time when a value of them occurs, a tally mark is added to the chart in the appropriate column or row. When all the data is collected, the tallies are counted up and displayed in total in the next column or row. The final result is similar to that of a histogram.
 -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/area_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/area_chart.png)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/violin_plot.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/violin_plot.svg)

DistributionPatternsRanges
...
![top image](http://datavizcatalogue.com/methods/images/top_images/pictograph.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/pictogram.png)
...
The use of icons can sometimes help overcome differences in language, culture and education. Icons can also give a more representational view of the data. So for example, if your data is of 5 cars, you show 5 icons of cars in the chart.

Two things to avoid when using Pictogram Charts are:
Using them for large data sets, which makes values on the chart hard to count.Displaying partial icons, as this can add confusion to what they represent.
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/bubble_map.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/bubble_map.svg)
...
Bubble Maps are good for comparing proportions over geographic regions without the issues caused by regional area size, as seen on Choropleth Maps. However, a major flaw with Bubble Maps is that overly large bubbles can overlap other bubbles and regions on the map, so this needs to be accounted for.
 -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/radial_bar_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/radial_bar_chart.png)
...
Since our visual systems are better at interpreting straight lines, a regular Bar Chart is a better choice for comparing values. The main reason to use a Radial Bar Chart instead is aesthetic.
 -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/error_bars.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/error_bars.svg)
...
Error Bars always run parallel to a quantitative scale axis, so they can be displayed either vertically or horizontally, depending on whether the quantitative scale is on the Y or X axis. If there are two quantitative scales, then two pairs of Error Bars can be used for both axes.
-->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/point_and_figure_chart.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/point_and_figure_chart.svg)
...
<!--
Also known as a P&F Chart.

This chart is used to display the relationship between the supply and demand of a particular asset through a series of columns made up of Xs and Os. Point & Figure Charts are time-independent and focus primarily on an asset's filtered price actions. Point & Figure Charts do not plot the volume traded and their purpose is to indicate any supply and demand relationship changes, which are known as "breakouts". Point & Figure Charts also make it easier to detect support and resistance levels, and any trend lines that may exist. Recognising the patterns that occur in Point & Figure Charts is key to utilising them.

While Point & Figure Charts do display dates or time on their x-axis, these are in-fact markers for the key price action dates and are not part of a time scale. The y-axis is used as the value scale. The Xs represent rising prices, where demand overtakes supply (more buyers) and the Os represent falling prices, where supply overtakes demand (more sellers).

Before drawing a Point & Figure Chart, you first need to decide on the values you want to set for the box size and the reversal amount.  You also need to choose, from what time point you want to take the price changes: this could be the day's closing price or it could be the day's high or low depending on the direction of the previous column.

The box size determines how much the price needs to change before a new X or O symbol can be placed. This sets how much noise in the market you want to filter out of the chart by reducing the number of minute price fluctuations displayed. So for example, if you set the box size to $1, any price increases or decreases less than this amount will be ignored, but if the price change is equal to or over $1, then a symbol will be placed on the chart.

These price changes are kept in one direction (either rising or falling) within a single column, and a single column can only contain either Xs or Os, not both. So if the price is on a rising uptrend (with Xs) then only Xs will be plotted in a column (this includes both price increases and decreases). It's only once the predetermined reversal amount is hit that a new column can be started. So if you had a column of Xs and your reversal amount is $3, if a price drop of $3 or more occurs then you need to start a new column of Os to indicate that the direction of the market has changed into a declining trend. The same thing with a column of Os, if the price increases by $3, then the trend has reversed from falling to rising, and you can now plot on a new column.

The reversal amount affects the sensitivity of the chart: a smaller reversal amount would yield more price fluctuations, making the chart wider and providing more information on what has occurred in the markets. However, a larger reversal amount would filter out insignificant price fluctuations, condensing the chart.

Numbers are sometimes also displayed in columns to indicate the start of a new month. 1-9 are used to denote January (1) through to September (9) and A, B and C are used for October (A), November (B) and December (C).
-->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/stacked_area_graph.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/stacked_area_graph.png)

ComparisonsData over timePatterns

Area Graph

<!--
Stacked Area Graphs work the same way as simple Area Graphs, except for displaying multiple data series that start each point from the point left by the previous data series.
...
![top image](http://datavizcatalogue.com/methods/images/top_images/area_graph.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/area_graph.png)

PatternsData over time
...
More Area Graph variations in this blog post.
-->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/line_graph.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/line_graph.png)

PatternsData over timeComparisons
...
![top image](http://datavizcatalogue.com/methods/images/top_images/box_plot.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/box_plot.png)

DistributionRangeComparisonsPatterns
...
What the key values are, such as: the average, median, 25th percentile, etc.If there are any outliers and what their values are.If the data is symmetrical or not.How tightly is the data grouped.If the data is skewed and if so, in what direction.
Two of the most commonly used variation of Box Plot are: variable-width Box Plots and notched Box Plots.

You can find more on Box Plot variations in this blog post.
-->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/gantt_chart.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/gantt_chart.svg)

Data over timeProcesses & methodsRangesReference tool
...
Connecting arrows can be used to show which tasks are dependent on each other. Critical paths, the key activities required to finish the project can also be displayed with a series of highlighted arrows. Symbols can also be placed within a Gantt Chart to signify milestones and a vertical line running through the chart is used to highlight the current date.
 -->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/heatmap.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/heatmap.svg)

ComparisonsData over timePatternsRelationships
...
![top image](http://datavizcatalogue.com/methods/images/top_images/scatterplot.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/scatterplot.png)
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/network_diagram.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/network_diagram.svg)
...
By mapping out connected systems, Network Diagrams can be used to interpret the structure of a network by looking for any clustering of the nodes, how densely nodes are connected or how the diagram layout is arranged.

The two notable types of Network Diagrams are "undirected" and "directed". Undirected Network Diagrams only display the connections between entities, while directed Network Diagrams show if the connections are one-way or two-way through small arrows.
...
![top image](http://datavizcatalogue.com/methods/images/top_images/wordcloud.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/wordcloud.png)

Analysing TextDistribution / FrequencyProportions
...
Word Clouds can also be used to display words that have meta-data assigned to them. For example, in a Word Cloud of all the World's countries, the population could be assigned to each country's name to determine its size.
...
![top image](http://datavizcatalogue.com/methods/images/top_images/stacked_bar_graph.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/stacked_bar_graph.png)

ComparisonsProportionsPart-to-a-whole

Bar Chart

<!--
Unlike a Multiset Bar Graph which displays the bars side-by-side for multiple data series, Stacked Bar Graphs segment the bars on top of each other. They are used to show how a larger category is divided into smaller subcategories and what the relationship of each part has on the total amount. There are two types of Stacked Bar Graphs:
...
![top image](http://datavizcatalogue.com/methods/images/top_images/choropleth.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/choropleth.png)

ComparisonsLocationPatterns
...
![top image](http://datavizcatalogue.com/methods/images/top_images/bar_chart.png)
![image](http://datavizcatalogue.com/methods/images/anatomy/bar_chart.png)
...
More Bar Chart variations in this blog post.
-->
...
![top image](http://datavizcatalogue.com/methods/images/top_images/SVG/dot_map.svg)
![image](http://datavizcatalogue.com/methods/images/anatomy/SVG/dot_map.svg)

DistributionLocationPatterns
